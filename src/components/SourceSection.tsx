...
import { ChevronDown, UploadCloud, X, Video, Dice5, Server, HardDrive, Film, Database, Braces } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {hasEmbedding && (
                            <button
                                ...
                                className="text-[10px] px-2 py-0.5 rounded-full border transition-all bg-blue-50 text-blue-600 border-blue-200 hover:bg-blue-100 hover:border-blue-300 flex items-center gap-1"
                                title="View feature vector"
                            >
                                <Braces size={10} />
                                <span>Vector</span>
                            </button>
